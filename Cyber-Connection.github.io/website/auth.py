...
def search():
    ...
    return render_template("search.html", user=current_user, results=results, user_notes=user_notes)
...
def about():
    ...
    return render_template("about.html", user=current_user, **additional_info)
